...
class KafkaConsumerFactory {
    ...
    static <V> KafkaConsumer<String, V> createConsumer(String brokers, Deserializer<V> deserializer) {
        return new KafkaConsumer<String, V>(kafkaConsumerProperties(brokers, deserializer))
    }

    static <V> Properties kafkaConsumerProperties(String brokers, Deserializer<V> deserializer) {
